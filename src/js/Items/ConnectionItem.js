...
///////////////////////////////////////////////////////////////////////////////////////
    ...
    constructor(options)
    {
        ...
        this._circle = new paper.Shape.Circle(circleCenter, Rodan.Configuration.PLUGINS['rodan-client-wfb'].CONNECTION_CIRCLE_RADIUS);
        this._circle.fillColor = Rodan.Configuration.PLUGINS['rodan-client-wfb'].STROKE_COLOR;
