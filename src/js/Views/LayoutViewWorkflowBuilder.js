...
///////////////////////////////////////////////////////////////////////////////////////
    ...
    _initializeRadio()
    {
        ...
        Rodan.CoreChannel.on(Rodan.CoreEvents.EVENT__SERVER_ERROR, options => this._handleEventRodanError(options), this);
    }
    ...
    _handleButtonEdit()
    {
        this.rodanChannel.request(Rodan.AppEvents.REQUEST__WORKFLOWBUILDER_SHOW_WORKFLOW_VIEW, {workflow: this.model});
    }
    ...
    _handleButtonAddJob()
    {
        this.rodanChannel.request(Rodan.AppEvents.REQUEST__WORKFLOWBUILDER_SHOW_JOBCOLLECTION_VIEW, {workflow: this.model});
    }
    ...
    {
        this.rodanChannel.request(Rodan.AppEvents.REQUEST__WORKFLOWBUILDER_SHOW_WORKFLOWCOLLECTION_VIEW, {workflow: this.model});
    }
    ...
    _handleButtonRun()
    {
        Rodan.CoreChannel.request(Rodan.CoreEvents.REQUEST__WORKFLOWBUILDER_CREATE_WORKFLOWRUN, {workflow: this.model});
    }
    ...
    _handleClickDataStatus()
    {
        ...
        {   
            this.rodanChannel.request(Rodan.AppEvents.REQUEST__MODAL_SHOW_SIMPLE, {title: 'Error code: ' + this._lastErrorCode, text: this._lastErrorDetails});
        }
    }
    ...
    _handleClickCheckboxAddPorts()
    {
        ...
        Rodan.CoreChannel.request(Rodan.CoreEvents.REQUEST__WORKFLOWBUILDER_SET_ADDPORTS, {addports: checked});
    }
